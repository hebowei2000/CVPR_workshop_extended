...
from net.module.modules import Reduction, ConcatOutput, weight_init, encoder_w, Bottle2neck, ASPP


class exp_7(nn.Module):
    def __init__(self, channel=128):
        super(exp_7, self).__init__()
        ...
        self.ppm = ASPP(in_channel=2048, depth=2048)
