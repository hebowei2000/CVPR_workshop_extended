...
def main():
    ...
    parser.add_argument('--path',type=str,default='../data/gt',help='data argument file')
    ...
    for path in paths:
       ...
       # cv2.imwrite(path+'_rotate90_scale_08',rotate_90_scale_08_Image)
        ...
        cv2.imwrite(path[:-4]+'_90'+path[-4:],rotate_90_scale_10_Image)
        #scale = 1.5
       ...
       # cv2.imwrite(path+'_rotate180_scale08',rotate_180_scale_08_Image)
        ...
        cv2.imwrite(path[:-4]+'_180'+path[-4:],rotate_180_scale_10_Image)
        #scale = 1.5
       ...
       # cv2.imwrite(path+'_rotate270_scale-08',rotate_270_scale_08_Image)
        ...
        cv2.imwrite(path[:-4]+'_270'+path[-4:],rotate_270_scale_10_Image)
